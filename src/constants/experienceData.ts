    ...
    data: [
      {
        ...
        description:
          "React.js va Redux Toolkit yordamida ichki dashboardlar va hisobot tizimlarini ishlab chiqdim. Skeleton va Ant Design komponentlaridan foydalanganman.",
      ...
      },
      {
        ...
        endDate: "Hozirgi vaqt",
        description:
          "React + JS bilan onlayn do‘kon interfeysini yaratdim. Mahsulotlar, filtrlar, swiper karusel va i18next integratsiyasini amalga oshirdim.",
      ...
      },
      {
        ...
        endDate: "Hozirgi vaqt",
        description:
          "4-yil, Computer Engineering fakulteti. Loyiha va kurs ishlarida React, JS, TypeScript, Node.js, Git kabi texnologiyalarni qo‘llaganman.",
